...
@app.get('/')
def mensaje():
    return "Bienved@!\ Esta es una API de Efrain Linares para realizar consultas sobre juegos de STEAM."
...
def get_developer_stats(desarrollador: str):
    ...
    data = pd.read_csv(r'C:\Users\EFRAIN LINARES\Desktop\Henry PI 1\ETL\games_clean.csv')
...
def developer_reviews_analysis(desarrollador: str):
    ...
    sentiment = pd.read_parquet(r'C:\Users\EFRAIN LINARES\Desktop\Henry PI 1\PI MLOps - STEAM\PARQUET\analisis_sentiment.parquet')
